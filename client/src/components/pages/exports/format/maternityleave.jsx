...
const maternityleave = ({
  ...
  pdf.text(`เรื่อง ขออนุญาตลาคลอดบุตร`, 25, 49);
  ...
  pdf.addImage(checked, "jpeg", 50, 92.5, 5, 5);
  ...
  pdf.addImage(blank, "jpeg", 65, 106.2, 5.1, 5.1);
  pdf.addImage(checked, "jpeg", 91, 106.25, 5, 5);
  pdf.text(
  ...
  pdf.autoTable({
    ...
    body: [
      ...
      ["ลาคลอด", `${prevStat.ML_DayCount}`,
        `${leaveData[0].numDay}`,
        `${prevStat.ML_DayCount + leaveData[0].numDay}`,],
    ],
