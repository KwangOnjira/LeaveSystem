...
const cancelleave = ({
  ...
  console.log("leaveData[0].leaveID:", leaveData[0].cancelID);
  console.log("userSignature:", userSignature);
  console.log("prevleave:", prevleave);
  ...
  pdf.addFileToVFS("MyFont.ttf", font);
    ...
    pdf.setFontSize(20);
    pdf.text(`ใบขอยกเลิกวันลา`, width / 2, 23, {
      align: "center",
    });
  ...
  const blank =
    ...
    pdf.text(`เรื่อง ขอยกเลิกวันลา`, 25, 49);
    pdf.text(`เรียน ${leaveData[0].to}`, 25, 56);
    pdf.text(
        `                 ตามที่ข้าพเจ้า............................................................................................................................................  ตำแหน่ง......................................................................................... สังกัด...................................................................... ได้รับอนุญาตให้ลาพักผ่อน ตั้งแต่วันที่.................................. ถึงวันที่.................................. รวม........................วัน นั้น`,
        25,
        63,
        { maxWidth: 170 }
      );
    pdf.text(
        `                 เนื่องจาก(ระบุเหตุผล)......................................................................................................................................................................................................................................................................................................................... จึงขอยกเลิกวันลาพักผ่อน จำนวน...................วัน ตั้งแต่วันที่...................................... ถึงวันที่....................................... `,
        25,
        84,
        { maxWidth: 170 }
      );
      pdf.setFontSize(14);
      pdf.text(`${userData.prefix} ${userData.name} ${userData.surname}`, 70, 62.5);
      pdf.text(`${userData.position}`, 40, 69);
      pdf.text(`${userData.divisionName}`, 132, 69);
      pdf.text(`${formatLeaveDate(prevleave[0].firstDay)}`, 85, 75.5);
      pdf.text(`${formatLeaveDate(prevleave[0].lastDay)}`, 127, 75.5);
      pdf.text(`${prevleave[0].numDay}`, 170, 75.5);
      pdf.text(`                                                   ${leaveData[0].reason}`, 25, 83.5,{ maxWidth: 170 });
      pdf.text(`${leaveData[0].cancelNumDay}`, 82, 96);
      pdf.text(`${formatLeaveDate(leaveData[0].cancelFirstDay)}`, 120, 96);
      pdf.text(`${formatLeaveDate(leaveData[0].cancelLastDay)}`, 166, 96);

      pdf.setFontSize(16);
  pdf.text("ขอแสดงความนับถือ", 115, 110);
  pdf.addImage(userSignature, "jpeg", 126, 113, 10, 5);
  pdf.text(`(ลงชื่อ)...............................................`, 100, 119);
  pdf.text(
    `(    ${userData.prefix} ${userData.name} ${userData.surname}    )`,
    106,
    124
  );
  pdf.text(`ตำแหน่ง   ${userData.position}`, 100, 130);

  pdf.setFont("MyFontBold", "bold");
  pdf.text("ความเห็นของผู้บังคับบัญชา", 25, 146);

  pdf.setFont("MyFont", "normal");
  pdf.text(`      ${leaveData[0]?.comment ?? "-"}`, 25, 152, { maxWidth: 170 });
  pdf.text(
    `..................................................................................................................................................................................................................................................................................................................................................................................`,
    25,
    153,
  ...
  if (firstSignature) {
    pdf.addImage(firstSignature, "jpeg", 125, 163, 10, 5);
    pdf.text(
      `(ลงชื่อ)...............................................`,
      100,
      169
  ...
  pdf.setFont("MyFontBold", "bold");
  pdf.text("คำสั่ง", 25, 203);

  pdf.setFont("MyFont", "normal");
  pdf.addImage(checked, "jpeg", 95, 209, 5.1, 5.1);
  pdf.addImage(blank, "jpeg", 118, 209, 5, 5);
  pdf.text(`อนุญาต          ไม่อนุญาต`, 102, 213);

  pdf.addImage(secondSignature, "jpeg", 125, 217, 10, 5);
  pdf.text(`(ลงชื่อ)...............................................`, 100, 223);
  pdf.text(
