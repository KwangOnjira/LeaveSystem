...
const ordinationleave = ({
  ...
  pdf.setFontSize(20);
  pdf.text(`ใบลาอุปสมบท`, width / 2, 23, {
    align: "center",
  });
  ...
  pdf.text(
    `               ข้าพเจ้า........................................................... ตำแหน่ง.............................................................................  ระดับ...............................................................   สังกัด.................................................................................................. เกิดวันที่................................... เข้ารับราชการเมื่อวันที่...................................`,
    25,
    63,
    { maxWidth: 170 }
  );
  ...
  pdf.text(
    `ข้าพเจ้า                ยังไม่เคย               เคย  อุปสมบท`,
    25,
    83
  );
  if (leaveData[0].ordinationleave.useTo === "false") {
    pdf.addImage(checked, "jpeg", 50, 79.5, 5.1, 5.1);
    pdf.addImage(blank, "jpeg", 80, 79.4, 5, 5);
  } else {
    pdf.addImage(blank, "jpeg", 50, 79.4, 5, 5);
    pdf.addImage(checked, "jpeg", 80, 79.5, 5.1, 5.1);
  }

  pdf.text(
    `               บัดนี้ มีศรัทธาจะอุปสมบทในพระพุทธศาสนา ณ วัด................................................................................. ตั้งอยู่ ณ .........................................................................................................................................................................  กำหนดอุปสมบท วันที่................................... และจำพรรษาอยู่ ณ วัด.......................................................................... ตั้งอยู่ ณ ......................................................................................................................................................................... ตั้งแต่วันที่................................... ถึงวันที่................................... มีกำหนด............................วัน`,
    25,
    91,
    { maxWidth: 170 }
  );
  ...
  pdf.setFontSize(16);
  pdf.text("ขอแสดงความนับถือ", 115, 124);
  pdf.addImage(userSignature, "jpeg", 126, 129, 10, 5);
  pdf.text(`(ลงชื่อ)...............................................`, 100, 135);
  pdf.text(
  ...
  pdf.setFont("MyFontBold", "bold");
  pdf.text("ความเห็นของผู้บังคับบัญชา", 25, 158);

  pdf.setFont("MyFont", "normal");
  pdf.text(`      ${leaveData[0]?.comment ?? "-"}`, 25, 165, { maxWidth: 170 });
  pdf.text(
    `..................................................................................................................................................................................................................................................................................................................................................................................`,
    25,
    166,
  ...
  if (firstSignature) {
    pdf.addImage(firstSignature, "jpeg", 145, 176, 10, 5);
    pdf.text(
      `(ลงชื่อ)...............................................`,
      120,
      182
  ...
  pdf.setFont("MyFontBold", "bold");
  pdf.text("คำสั่ง", 25, 219);

  pdf.setFont("MyFont", "normal");
  pdf.addImage(checked, "jpeg", 25, 221, 5.1, 5.1);
  pdf.addImage(blank, "jpeg", 49, 221, 5, 5);
  pdf.text(`อนุญาต          ไม่อนุญาต`, 31, 225);
